...
import com.example.finalandroid.presentation.viewmodel.ActorViewModel
import com.example.finalandroid.data.adapters.ActorFilmBestAdapter
import com.example.finalandroid.presentation.viewmodel.ActorFilmBestViewModel
...
class ActorPage : Fragment() {
    ...
    private val vmActorFilm: ActorFilmBestViewModel by viewModels()
